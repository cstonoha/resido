...
create_aa_heatmap <- function(file){
  ...
  # Create the heatmap
  p <- ggplot2::ggplot(melted_data, ggplot2::aes(x = amino_acid, y = seq_name, fill = value)) +
    ggplot2::geom_tile() +
    ggplot2::scale_fill_gradient(low = "white", high = "purple", name = "Amino Acid Density") +
    ggplot2::labs(x = "Amino Acid", y = "Sequence Name", title = "Amino Acid Density Heatmap") +
    ggplot2::theme_bw() +
